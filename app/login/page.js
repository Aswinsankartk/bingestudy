    ...
    <main className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md border border-gray-200 rounded-2xl p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3 text-sm font-medium text-black hover:bg-gray-50 transition-all duration-200 mb-6"
        >
