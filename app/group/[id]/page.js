...
export default function GroupRoom() {
  ...
  useEffect(() => {
    ...
    // Clean up channel listener on unmount/id change
    return () => {
      if (channel) {
              ...
              messages.map((msg, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* FIXED: Removed duplicate message bubble logic chains */}
            ...
            {replyingTo && (
              <div className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 mb-2 animate-fade-in-up">
                ...
                <button
                  ...
                  className="text-gray-400 hover:text-black transition-all shrink-0 ml-2"
                >
                  <X size={14} />
                </button>
              </div>
...
//     // Build a map of all messages by id for quick reply lookup
//     const messageMap = {};
//     msgs.forEach((m) => {
//       messageMap[m.id] = m;
//     });
